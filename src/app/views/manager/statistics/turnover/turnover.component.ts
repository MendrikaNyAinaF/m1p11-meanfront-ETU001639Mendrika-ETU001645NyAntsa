...
import {TurnoverService} from "../../../../services/statistics/turnover/turnover.service";
...
export class TurnoverComponent implements OnInit {
    ...
    constructor(private dateUtil: DateUtilService, private turnoverService: TurnoverService) {
    }

    ngOnInit(): void {
        const dates: any[] = this.dateUtil.getFirstAndLastDateInCurrentMonth();
        this.getTurnover({byWhat: this.byWhat, startDate: dates[0], endDate: dates[1]});
    ...
    getTurnover = (data: any) => {
        ...
        return new Promise((resolve, reject) => {
            this.turnoverService.getTurnover(data).then((data: any) => {
                console.log(data)
